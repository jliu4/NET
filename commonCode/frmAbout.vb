...
Friend Class frmAbout
	...
	Const KEY_ALL_ACCESS As Single = KEY_QUERY_VALUE + KEY_SET_VALUE + KEY_CREATE_SUB_KEY + KEY_ENUMERATE_SUB_KEYS + KEY_NOTIFY + KEY_CREATE_LINK + READ_CONTROL
	...
	Public Sub StartSysInfo()
		...
		Exit Sub
SysInfoErr: 
		MsgBox("System Information Is Unavailable At This Time", MsgBoxStyle.OKOnly, Me.Text)
	End Sub
	...
	Public Function GetKeyValue(ByRef KeyRoot As Integer, ByRef KeyName As String, ByRef SubKeyRef As String, ByRef KeyVal As String) As Boolean
		...
		Select Case KeyValType ' Search Data Types...
			...
			Case REG_DWORD ' Single Word Registry Key Data Type
				For i = Len(tmpVal) To 1 Step -1 ' Convert Each Bit
					KeyVal = KeyVal & Hex(Asc(Mid(tmpVal, i, 1))) ' Build Value Char. By Char.
				Next 
				KeyVal = VB6.Format("&h" & KeyVal) ' Convert Single Word To String
		End Select
...
GetKeyError: ' Cleanup After An Error Has Occured...
    ...
    Private Sub _lblDescription_1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles _lblDescription_1.Click
