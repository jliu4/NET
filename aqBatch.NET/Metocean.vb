...
Friend Class Metocean
	...
	Public WriteOnly Property Heading() As Single
        Set(ByVal Value As Single) 'JLIU TODO

            mclsWind.Heading = CType(Value, Object)
            mclsCurrent.Heading = CType(Value, Object)
            mclsWave.Heading = CType(Value, Object)
            mclsWave.SwellHeading = CType(Value, Object)
	...
	Public Function ReadData(ByVal fnum As Integer, ByVal UDEF As Boolean) As Object
		...
		Else
			...
			If UDEF Then
                ...
                mclsWave.SwellHeading = CType(Fields(14), Object)
