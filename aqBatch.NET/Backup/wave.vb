...
Friend Class Wave
	...
	'UPGRADE_ISSUE: VB.Data type was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6B85A2A7-FE9F-4FBE-AA0C-CF11AC86A305"'
	'UPGRADE_ISSUE: VB.Data type was not upgraded. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6B85A2A7-FE9F-4FBE-AA0C-CF11AC86A305"'
	...
	Private Function ISSC(ByVal w As Double) As Double
		...
		If w = 0# Then
			ISSC = 0#
		Else
			'UPGRADE_WARNING: Couldn't resolve default property of object msngFrequency. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
			wp = CDbl(msngFrequency)
			If wp = 0# Then
				A1 = 0#
			Else
