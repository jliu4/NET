	...
	Public ReadOnly Property VelCorr() As Single
		Get
			...
			If Not mblnUpdated Then
				'UPGRADE_WARNING: Couldn't resolve default property of object msngVelocity. Click for more: 'ms-help://MS.VSCC.v80/dv_commoner/local/redirect.htm?keyword="6A50421D-15FE-4896-8A1B-2EC21E9037B2"'
				msngVelCorr = CDbl(msngVelocity) * (msngElevation / RefElev) ^ 0.2 * DurCorr(mintDuration)
				mblnUpdated = True
			End If
			VelCorr = msngVelCorr
