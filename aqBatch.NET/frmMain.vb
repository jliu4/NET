...
ErrHandler: 
	...
	Private Function CreateEnvFile(ByVal Index As Short) As Boolean
        ...
        End If
            ...
            Else ' PSMZ
                PrintLine(OutFile, "    13XSWL PSMZ", TAB(42), CStr(Format(Val(CStr(oMet(Index).Wave.SwellHeight * Flen)), "#0.0")), TAB(52), CStr(Format(oMet(Index).Wave.SwellPeriod / 1.4, "#0.000")), TAB(72), CStr(VB6.Format(Val(oMet(Index).Wave.SwellHeading), "#0.0")))
            End If
			Else
