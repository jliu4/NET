Option Strict Off
Option Explicit On
Friend Class DODOIni
	' DODOIni       DODO configuration data (DODO.ini)
	' Version 1.0.1
	...
	Private Sub Class_Initialize_Renamed()
		...
		mstrWorkDir = DODODir
		If mstrWorkDir = "" Then mstrWorkDir = DODODirDefault & "\"
    ...
    Public Sub DelPreFile(ByVal Index As Integer)

        mcolPreFile.Remove(Index)

    End Sub
	
	Public Function PreFile(ByVal Index As Integer) As String
