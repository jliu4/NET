...
Friend Class EnvLoad
    ...
    Public ReadOnly Property Wave2FC(ByVal Direction As Double, Optional ByVal Draft As Double = 0) As Force
        Get
    ...
    Public ReadOnly Property FEnvLocl(Optional ByVal Heading As Object = Nothing, Optional ByVal Vsurge As Double = 0#, Optional ByVal Vsway As Double = 0#, Optional ByVal ReCalculate As Boolean = True) As Force
        Get
...
ErrorHandler:
    ...
    Private Sub FEnv(ByRef FWindLocl As Force, ByRef FWindGlob As Force, ByRef FCurrLocl As Force, ByRef FCurrGlob As Force, ByRef FWaveLocl As Force, ByRef FWaveGlob As Force, ByRef FEnvLocl As Force, ByRef FEnvGlob As Force, ByVal Heading As Double, Optional ByRef Vsurge As Double = 0#, Optional ByRef Vsway As Double = 0#)
        ...
        Dim EnvDirCorr, EnvDir, MP As Double
        Dim Vy, Vx, Vcorr As Double
