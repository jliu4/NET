...
ErrHandler:
    ...
    Private Sub btnTransient_Click(ByVal eventSender As System.Object, ByVal eventArgs As System.EventArgs) Handles btnTransient.Click
        ...
        For i = 1 To NumTimeSteps
            ...
            If Dist > Dist0 Then
                k = 1
                Do While Dist0 / ZWD * 100.0# - k * 2 > 0#
                    k = k + 1
                Loop
                If Dist / ZWD * 100 - k * 2 >= 0# And k < 9 Then
                    With CurVessel.EnvLoad.EnvCur.Current
                        ...
                        For L = 1 To NumCurrent
                            CurX = .Profile(L).Velocity * System.Math.Cos(CurDir_Renamed) - Vel(2).Surge * (1.0# - Depth(L) / ZWD)
                            CurY = .Profile(L).Velocity * System.Math.Sin(CurDir_Renamed) - Vel(2).Sway * (1.0# - Depth(L) / ZWD)
        ...
        txtOffsetPWD.Text = Format(PWD * 100.0#, "#0.0") ' final offset percent WD
        ...
        txtMaxOffsetPWD.Text = Format(PWD * 100.0#, "#0.0") ' Max Transient Offset Percent WD
